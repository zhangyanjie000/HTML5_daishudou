	            ...
	            <div class="mui-content mui-scroll-wrapper" >
	                <div class="mui-scroll">
	                    ...
	                    <div class="actcle1"style="text-align:center;padding-top:5px;">
	                    	<img src="/zhong_daishudou/daishudou/Practicum/Public/Former/images/qinzi_4.jpg"style="width:200px;height:150px;">
	                    </div>
	                    <form class="mui-input-group">
						    <div class="mui-input-row">
						        <label>标题：</label>
						        <p style="text-align:left;padding-top:10px;color:black;"><?php echo ($article_user["e_title"]); ?>
						        </p>
						    </div>
						    <div class="mui-input-row">
						        <label>地点：</label>
						    	<p style="text-align:left;padding-top:10px;color:black;"><?php echo ($article_user["e_address"]); ?>
						    	</p>
						    </div>
						    <div class="mui-input-row">
						        <label>日期：</label>
						    	<p style="text-align:left;padding-top:10px;color:black;"><?php echo ($article_user["e_time"]); ?>
						    	</p>
						    </div>
						    <div class="mui-input-row" style="height:300px;">
						    	...
						    	<textarea cols="40" rows="10" style="height:100%;"  name="textarea" id="textarea"  placeholder="详细内容">
						    		<?php echo ($article_user["e_details"]); ?>
						    	</textarea>
						    </div>
						</form>		    
	            </div>
