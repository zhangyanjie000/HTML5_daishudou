...
<script type="text/javascript" charset="utf-8">
		...
		initPhotoSwipeFromDOM('.my-simple-gallery');			
				...
				function openarticleWindow2(a){
					this.a=a;
		    mui.openWindow({
			url    :'/zhong_daishudou/daishudou/Practicum/index.php/Home/babyfood/article2.html'+"?id="+a,
		...
		function openarticleWindow1(a){
					this.a=a;
		    mui.openWindow({
			url    :'/zhong_daishudou/daishudou/Practicum/index.php/Home/babyfood/article1.html'+"?id="+a,

		    });
		}
		function openPublish(){
		    mui.openWindow({
			url    :'/zhong_daishudou/daishudou/Practicum/index.php/Home/Babyfood/publish.html',
			id:'publish.html'
		    });
		}
