					...
					<div>
						<ul class="mui-table-view mui-table-view-chevron">
							...
							<?php if(is_array($area)): $i = 0; $__LIST__ = $area;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?><li class="mui-table-view-cell mui-media"style="text">
									...
									<a href="javascript:;" onclick="openarticleWindow2(<?php echo ($d["article_id"]); ?>);"  style="float:left">
...
<script type="text/javascript" charset="utf-8">
	...
	function openarticleWindow2(a){
		this.a=a;
		mui.openWindow({
			url    :'/zhong_daishudou/daishudou/Practicum/index.php/Home/Communication/article2.html'+"?id="+a,
	...
	function openarticleWindow1(a){
		this.a=a;
		mui.openWindow({
			url    :'/zhong_daishudou/daishudou/Practicum/index.php/Home/Communication/article1.html'+"?id="+a,

		});
	}
	function openPublish(){
		mui.openWindow({
			url    :'/zhong_daishudou/daishudou/Practicum/index.php/Home/Communication/publish.html',
			id:'publish.html'
		});
	}
