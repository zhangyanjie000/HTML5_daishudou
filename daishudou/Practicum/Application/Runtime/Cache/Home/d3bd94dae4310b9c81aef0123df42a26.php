...
<script type="text/javascript" charset="utf-8">
	...
	function openarticleWindow2(a){
		this.a=a;
		mui.openWindow({
			url    :'/zhong_daishudou/daishudou/Practicum/index.php/Home/Weightloss/article2.html'+"?id="+a,
	...
	function openarticleWindow1(a){
		this.a=a;
		mui.openWindow({
			url    :'/zhong_daishudou/daishudou/Practicum/index.php/Home/Weightloss/article1.html'+"?id="+a,

		});
	}
	function openPublish(){
		mui.openWindow({
			url    :'/zhong_daishudou/daishudou/Practicum/index.php/Home/Weightloss/publish.html',
			id:'publish.html'
		});
	}
