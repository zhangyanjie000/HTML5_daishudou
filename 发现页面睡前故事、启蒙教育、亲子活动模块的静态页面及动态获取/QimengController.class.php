...
class QimengController extends Controller {
    public function index() {
        ...
        $articeResult1= $articeModel2->limit("3")->where('title_type = 7 and user_id = 1')->select();
        ...
        $articeResult6= $articeModel2->limit("3")->where('title_type = 7 and user_id = 2')->select();
        //dump($articeResult1);exit;
        $this->assign("artice1",$articeResult6);

        $articeResult7= $articeModel2->limit("3")->where('title_type = 7 and user_id = 3')->select();
        //dump($articeResult1);exit;
        ...
        $articeResult5= $articeModel->limit("10")->where("a_type=".$b)->select();
